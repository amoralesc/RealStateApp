package com.webdev.realstate.properties.address.infrastructure.controllers;

import com.webdev.realstate.properties.address.application.create.AddressCreator;
...
public class AddressCreateController {
    ...
    public ResponseEntity execute(@RequestBody AddressCreatorRequest request) {
        creator.execute(request.getId(), request.getCity(), request.getDetail(),
                request.getAdditionalInfo(), request.getNeighborhood(),
                request.getUserId());
